...
Ti.App.twitterApi = new TwitterApi({
	// ここを変更してください。
	consumerKey:    'BenKiQZEs313eaJ7fMn4Q',
	consumerSecret: 'Vcj9j5wQni54TbXlRvkgKSxSkV3EdQUTbEyt1h5aY'
});
...
(function() {
	...
	TiTwitter.UI.createTweetWindow = function(thisTweet) {
		...
		newWindow.add((function() {
			...
			thisTweet.text = linkifyTweet(thisTweet.text);
			Ti.API.info(thisTweet.text);
...
function linkifyTweet(tweet) {
  ...
  return tweet.replace(/#([\w一-龠ぁ-んァ-ヴー]+)/g , '<a href="http://search.twitter.com/search?&q=%23$1">#$1</a>');
};